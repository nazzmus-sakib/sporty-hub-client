            ...
            <tr key={classes._id}>
              ...
              <td className="flex justify-center items-center gap-2">
                <button
                  ...
                  class="relative inline-flex items-center justify-start px-2 py-1 overflow-hidden font-medium transition-all bg-green-200 rounded hover:bg-white group"
                >
                ...
                <button className="relative inline-flex items-center justify-start px-2 py-1 overflow-hidden font-medium transition-all bg-blue-200 rounded hover:bg-white group">
